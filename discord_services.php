        ...
        <div class="page-header-content">
            <div class="page-header-inner">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Discord Service</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="services">
    <h2>SERVICES</h2>
    <span>Why Should You Join an NFT Discord Community?</span>
   ...
   <!-- <img src="http://www.economicmodeling.com/wp-content/uploads/warehousing.jpg" width=700 alt="">-->
    ...
    <p>There are some NFT artist discord communities specifically for NFT artists. This platform is a great way for you
        ...
        don’t feel left alone in the chaotic world on NFT.</p>
    <span>4. NFT Beginner/Newbie</span>
    <p>As a learner/beginner just testing the waters on NFT, the first thing you should do is find the right NFT Discord
        community to join. This would help you gain knowledge about the NFT world from people who’ve already been there
