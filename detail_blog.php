...
<section class="blog-section padding-top padding-bottom" style="background: #040b29">
    <div class="container">
        <div class="main-blog">
            <div class="row g-5">
                        ...
                        <div id="comments" class="comments">
                            ...
                            <ul class="comment-list">
                                <li class="comment" id="li-comment-2">
                                    <div class="com-image">
                                        <img alt="author" src="assets/images/seller/04.png" class="avatar"
                                             height="70" width="70">
                                    </div>
                                    ...
                                    <ul class="comment-list">
                                        <li class="comment even thread-even depth-1 comment" id="li-comment-3">
                                            <div class="com-image">
                                                <img alt="author" src="assets/images/seller/01.gif" class="avatar"
                                                     height="70" width="70">
                                            </div>
                                            <div class="com-content">
                                                <div class="com-title">
                                ...
                                <form action="#" method="post" id="commentform" class="comment-form" novalidate="">
                                    <div class="row w-100 g-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-floating">
                                                <input type="email" class="w-100 comment-input form-control"
                                                       id="authorEmail" placeholder="Your Email">
                                                <label for="authorEmail">Your Mail</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating w-100">
                                                ...
                                                <label for="cmntSub">Subject</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <button class="default-btn move-right" type="submit"><span>Send
                                                    Comment</span></button>
                                    </div>
